<template>
    <div class="flex flex-col h-max justify-center bg-[#062a74] text-white">
        <div class="flex items-center justify-between py-4 pl-4 border-b-2  border-blue-400">
            <h1 @click="$emit('changeComponentAafficher','ProjetsDuType')"
        ...
        <div class="flex justify-between items-center flex-wrap my-[20px]">
            <div class="flex items-center justify-center flex-wrap w-full h-max ">
...
<script>
export default {
    emits: ["changeComponentAafficher"],
    props: {
        projet: {
            type:Object
        }
