<template>
    <div>
        <div class="py-[15px] pr-[20px] text-end">
            <button
                class=" bg-blue-600 text-white w-[150px] py-1.5 px-3 rounded-[10px] font-[600] tracking-[0.5px] hover:bg-blue-500  duration-300 ">Ajouter
        ...
        <div class="flex items-center">
            <div v-for="demande in mesDemandes" :key="demande.id"
                ...
                <div class=" space-x-3">
                    <button
                        class="border-2 border-red-500 text-black w-[120px] py-1.5 px-3 rounded-[5px] font-[400] tracking-[0.5px] hover:bg-red-600 hover:text-white duration-300 ">supprimer</button>
                    <button
                        class="border-2 bg-green-600 text-white w-[120px] py-1.5 px-3 rounded-[5px] font-[400] tracking-[0.5px] hover:border-green-700 hover:bg-inherit hover:text-black  duration-300 ">modifier</button>
                </div>
            </div>
        </div>
    </div>
